...
title: "croni"
date: 2017-08-20
description: "Croni is a simple cron based CI server with a responsive bootstrap powered web client. It enables Continuous Integration with almost no setup, just add your build and test scripts an trigger them periodically to get a notification about errors beforehand and not while compiling."
tags: ['web', 'testing', 'ci']
---
## Why?
